    ...
    <div class="cart_del_bar" v-if="fullNumber>0">
      <div class="cart_del_info df aic">
        ...
        <p>
          ...
          <span class="colC9" @click="handleDel">hapus sekali klik</span>
        </p>
    ...
    <div class="cart_topay_bar" v-if="tableData.length>=0">
      <div class="cart_topay_con df aic">
        ...
        <div class="cart_pay_count f1">
          <p>
            Jumlah total
            <span class="cart_pay_color">Rp {{$globals.dataUtil.parseNumber(totalAmount)}}</span>
          </p>
          <p>
...
export default {
  ...
  methods: {
    ...
    handleCount() {
      ...
      let _amount = 0;
      _this.tableData.forEach(v => {
        _amount += v.totalAmount * (v.count / 100) + v.insurance;
      });
